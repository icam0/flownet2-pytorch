...
def normalize(im0,im1):

    im0_mean = np.array((0.45014125, 0.4320596, 0.4114511))
    im1_mean = np.array((0.44855332, 0.43102142,0.41060242))
    im0_norm = im0-im0_mean
    im1_norm = im1-im1_mean

    return im0_norm,im1_norm

def denormalize(im0_norm,im1_norm):
    im0_mean = np.array((0.45014125, 0.4320596, 0.4114511))
    im1_mean = np.array((0.44855332, 0.43102142,0.41060242))
    im0 = im0_norm+im0_mean
    im1 = im1_norm+im1_mean
    im0[im0 < 0.], im1[im1 < 0.] = 0., 0.
    im0[im0 > 1.], im1[im1 > 1.] = 1., 1.
    return im0,im1
